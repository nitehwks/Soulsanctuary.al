/**
 * Production proxy for Clerk's Frontend API.
 *
 * Replit-managed Clerk uses this endpoint on published apps so the browser
 * SDK stays on the application's domain.
 */
