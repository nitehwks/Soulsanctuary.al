       ...
       <div className="flex h-full">
         ...
         <div className="flex-1 overflow-auto">
            <div className="max-w-3xl mx-auto p-8 space-y-8">
                <div>
                    <h1 className="text-4xl font-heading font-bold text-foreground mb-4">TrustHub Documentation</h1>
                    <p className="text-lg text-muted-foreground leading-relaxed">
                        TrustHub is a privacy-first artificial intelligence platform designed for enterprise environments where data security is paramount. It employs advanced obfuscation techniques to learn from user interactions without compromising sensitive information.
                    </p>
                </div>

                <div className="space-y-4">
                    <h2 className="text-2xl font-bold font-heading text-primary">AI Engine Specifications</h2>
                    <p className="text-muted-foreground leading-relaxed">
                        TrustHub is powered by the <strong>Dolphin 3</strong> 8B parameter model. This model is specifically fine-tuned for:
                    </p>
                    <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                        <li><strong className="text-foreground">uncensored compliance:</strong> capable of handling complex enterprise queries without generic refusals.</li>
                        <li><strong className="text-foreground">cognitive reasoning:</strong> enhanced logic for data structuring and schema generation.</li>
                        <li><strong className="text-foreground">privacy awareness:</strong> trained to recognize and flag sensitive PII patterns before processing.</li>
                    </ul>
                </div>
